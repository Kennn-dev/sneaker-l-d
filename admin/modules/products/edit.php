...
//active navbar
  ...
  $editProducts = $db->fetchID('products',$id);  
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title "><?php echo $editProducts['name'] ?> :</h4>
                  <div class="d-fex">
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <input 
                          ...
                          name="name"
                          value="<?php echo $editProducts['name'] ?>"
                        >
                    ...
                    <div class="form-group">
                        ...
                        <input 
                          ...
                          aria-describedby="emailHelp"
                          name="price"
                          value="<?php echo $editProducts['price'] ?>"
                        >
                        <div class="has-danger">
                    ...
                    <div class="">
                      ...
                      <div class="has-danger">
                        ...
                        <img class="mt-3" width="80px" height="80px" src="/fruitstore/public/uploads/products/<?php echo $editProducts['image'] ?>" alt="">
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <?php foreach($categories as $item ): ?>  
                        <option 
                            ...
                            <?php echo $editProducts['categoryID'] == $item['id'] ? 'selected' :''?>
                        >
                            <?php echo $item['name'] ?>
                        </option>
                      <?php endforeach ?>  
                    ...
                    <div class="form-group">
                        ...
                        <textarea 
                          ...
                          rows="3"
                          name="description"
                        ><?php echo $editProducts['description'] ?></textarea>
                        <div class="has-danger">

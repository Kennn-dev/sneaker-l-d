            ...
            <div class="humberger__menu__widget">
                <div class="header__top__right__language">
                    ...
                    <div class="header__top__right__auth">
                        <a href="loginForm.php"><i class="fa fa-user"></i>Login</a>
                    </div>
            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="header__top__right">
                                ...
                                <?php if(isset($_SESSION['username'])) : ?>
                                    <div class="header__top__right__auth">
                                        <a style="color : red;" href="logout.php"><i class="fa fa-user"></i>Log out</a>
                                    </div>
                                <?php else : ?>
                                    <div class="header__top__right__auth">
                                        <a href="loginForm.php"><i class="fa fa-user"></i>Login</a>
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="header__logo">
                            <a href="./index.php"><img src="public/frontend/img/logo.png" alt=""></a>
                        </div>
                    </div>
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-3">
                        <div class="header__cart">
                            <ul>
                                <li><a href="#"><i class="fa fa-heart"></i> <span>1</span></a></li>
                                <li><a href="addCart.php"><i class="fa fa-shopping-bag"></i> <span>3</span></a></li>
                            </ul>
                            <div class="header__cart__price">item: <span>$150.00</span></div>
                        </div>
                    </div>
